...
var taskInput=document.querySelector(".section_add-item__input");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    editInput.classList.add("list__item-input", "list__item-input_task");
    //button.edit
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".list__item-input_checkbox");
